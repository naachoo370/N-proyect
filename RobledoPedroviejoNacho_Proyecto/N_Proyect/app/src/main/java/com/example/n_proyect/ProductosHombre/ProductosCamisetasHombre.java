package com.example.n_proyect.ProductosHombre;
...
public class ProductosCamisetasHombre extends AppCompatActivity implements ProductoAdaptador.OnProductoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productos_categoria_camiseta_hombre);
    ...
    private void navigateTo(Class<?> destination) {
        ...
        if (!destination.equals(ProductosCamisetasHombre.class)) {
            finish();
        }
    }
    ...
    private void configurarBusqueda() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (newText.isEmpty()) aplicarFiltros();
                return true;
            }
        });
    }
    ...
    private void configurarFiltroTallas() {
        ...
        filtroTallas.setAdapter(adapter);
    ...
    private void cargarProductos() {
        List<Producto> productos = gestorBD.obtenerProductosCamisetasHombre();
    ...
    private void aplicarFiltros() {
        ...
        List<Producto> productos = gestorBD.filtrarProductos(talla, query);
        actualizarAdaptador(productos);
    }
