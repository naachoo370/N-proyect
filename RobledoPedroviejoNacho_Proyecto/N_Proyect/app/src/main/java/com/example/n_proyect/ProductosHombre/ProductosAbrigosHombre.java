...
public class ProductosAbrigosHombre extends AppCompatActivity implements ProductoAdaptador.OnProductoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productos_categoria_abrigos_hombre);
    ...
    // aplicar filtros de busqueda y talla
