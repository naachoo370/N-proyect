...
public class ProductosCamisetasMujer extends AppCompatActivity implements ProductoAdaptador.OnProductoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productos_categoria_camisetas_mujer);
    ...
    private void cargarProductosCamiseta() {
        List<Producto> productos = gestorBD.obtenerProductosCamisetasMujer();
