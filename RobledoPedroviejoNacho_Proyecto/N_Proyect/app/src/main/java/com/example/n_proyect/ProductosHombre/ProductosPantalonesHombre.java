...
public class ProductosPantalonesHombre extends AppCompatActivity implements ProductoAdaptador.OnProductoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productos_categoria_pantalones_hombre);
    ...
    private void navigateTo(Class<?> destination) {
        ...
        if (!destination.equals(ProductosPantalonesHombre.class)) {
            finish();
        }
    }
    ...
    private void cargarProductos() {
        List<Producto> productos = gestorBD.obtenerProductosPantalonesHombre();
