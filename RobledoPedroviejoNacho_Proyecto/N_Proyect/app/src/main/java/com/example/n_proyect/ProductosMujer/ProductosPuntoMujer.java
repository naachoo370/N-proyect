...
public class ProductosPuntoMujer extends AppCompatActivity implements ProductoAdaptador.OnProductoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productos_categoria_punto_mujer);
    ...
    private void cargarProductosPunto() {
        List<Producto> productos = gestorBD.obtenerProductosPuntoMujer();
