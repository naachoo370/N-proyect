...
public class ProductosPolosHombre extends AppCompatActivity implements ProductoAdaptador.OnProductoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productos_categoria_polos_hombre);
    ...
    private void navigateTo(Class<?> destination) {
        ...
        if (!destination.equals(ProductosPolosHombre.class)) {
            finish();
        }
    }
    ...
    private void cargarProductos() {
        List<Producto> productos = gestorBD.obtenerProductosPolosHombre();
