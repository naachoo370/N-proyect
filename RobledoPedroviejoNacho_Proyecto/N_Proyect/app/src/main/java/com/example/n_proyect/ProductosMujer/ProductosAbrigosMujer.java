...
public class ProductosAbrigosMujer extends AppCompatActivity implements ProductoAdaptador.OnProductoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productos_categoria_abrigos_mujer);
    ...
    private void cargarProductosPantalones() {
        List<Producto> productos = gestorBD.obtenerProductosAbrigosMujer();
    ...
    public void onProductoClick(int productoId) {
        ...
        // No pasar correoUsuario, se obtiene desde SesionManager
        startActivity(intent);
    }
}
