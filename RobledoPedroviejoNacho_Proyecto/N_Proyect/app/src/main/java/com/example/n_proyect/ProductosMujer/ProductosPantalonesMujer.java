...
public class ProductosPantalonesMujer extends AppCompatActivity implements ProductoAdaptador.OnProductoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productos_categoria_pantalones_mujer);
    ...
    private void cargarProductosPantalones() {
        List<Producto> productos = gestorBD.obtenerProductosPantalonesMujer();
