...
public class ProductosSudaderaHombre extends AppCompatActivity implements ProductoAdaptador.OnProductoClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productos_categoria_sudadera_hombre);
    ...
    private void cargarProductosSudaderas() {
        List<Producto> productos = gestorBD.obtenerProductosSudaderasHombre();
